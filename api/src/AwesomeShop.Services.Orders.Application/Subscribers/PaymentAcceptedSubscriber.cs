...
namespace AwesomeShop.Services.Orders.Application.Subscribers
{
    public class PaymentAcceptedSubscriber : BackgroundService
    {
        ...
        {
            _channel.ExchangeDeclare("order-service", "topic", true);
            _channel.ExchangeDeclare("payment-service", "topic", true);

            _channel.QueueDeclare("order-service/payment-accepted", true, false, false, null);
            _channel.QueueBind("order-service/payment-accepted", "payment-service", "payment-accepted");
